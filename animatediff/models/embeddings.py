...
# copy from https://mmdetection.readthedocs.io/en/v2.14.0/_modules/mmdet/models/utils/positional_encoding.html
class SinePositionalEncoding2D(nn.Module):
    ...
    def forward(self, x):
        ...
        pos_embed = self._forward(mask)

        x = x + pos_embed.to(x.dtype) # add
        return x
