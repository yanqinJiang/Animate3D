...
def parse_augment():
    ...
    parser.add_argument('--folder_path', type=str, default="./tmp", help="rgb image root") 
    parser.add_argument('--save_path', type=str, default="./tmp", help="rgba image root") 
    parser.add_argument('--template_mask_folder', type=str, default="./tmp", help="template mask root") 
